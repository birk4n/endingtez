...
die("5 Saniye içerisinde başka sayfaya yönlendirilecektir.");
}
?>
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Veri Yapıları Dersi</title>
        <meta charset="utf-8">
...
label{
    ...
    <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet">
        ...
        <script src="http://207.154.192.163/socket.io/socket.io.js"></script>
...
<!-- Script files -->
 ...
 const socket = io.connect('//207.154.192.163/voice');
